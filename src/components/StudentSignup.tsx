...
import { Mail, Lock, User, Phone, ArrowLeft, BookOpen } from 'lucide-react';
...
export function StudentSignup({ onBack, onSignupSuccess, onSwitchToLogin, backgroundImage }: StudentSignupProps) {
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            <h2 className="text-blue-600 mb-2">Student Sign Up</h2>
